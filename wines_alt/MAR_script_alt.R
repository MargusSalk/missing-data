...
p <- 37 #percentage of missing values added
attribute_modified <- 'quality'
related_attribute <- 'alcohol'
related_attribute_value <- 12 # delete 37% of data where quality > 6

# the plan: remove values of chosen attribute (e.g diameter) depending on some other attribute
# example used: remove given percentage of diameter values when Sex == 'M'
